<title>QuangKhai Services</title>
...
<br>
<a href='https://zalo.me/0352876128'><img height=100px width=100px src='https://i.imgur.com/kgnnEFy.gif'/>
<br>
<br>
<font color="#00FFCC">ANTI DDOS BY:<font color="#FFCCCC"> BUI QUANG KHAI </a></font></font><br /><br />
...
<script id="source" language="javascript" type="text/javascript">
    $(document).ready(function () {
        ...
        let layer7 = new Highcharts.Chart({
            ...
            title: {
                text: "HIT ==> https://checkscamdls.info/ PORT 443 <==",
                style: {
            color: 'white',
        ...
        function requestData(type) {
            $.ajax({
                ...
                success: function (point) {
                    ...
                    // Tính tổng và lưu giữ giá tr này vào Local Storage
            ...
            layer7.setTitle({
               ...
               document.getElementById('max-value').innerHTML = maxData;
                    ...
                    setTimeout(() => requestData(type), 600);
                },
                cache: false,
            });
        }
...
.total-value {
    color: white; /* màu total */
    font-weight: bold;
    font-size: 35px;
}

.max-value {
    color: white; /* màu peak req */
    font-weight: bold;
    font-size: 35px;
}
...
<a href="https://checkscamdls.info/tools" style="color: #FF3399; font-size: 44px; font-style: sans-serif"><ins><b>Tools</b></ins> </a>


</html>

<div id="jsi-flying-fish-container"></div><br><br>
<footer style="text-align: center; font-size: 40px; background-color: #272d47; color: white;">All rights reserved by Bùi Quang Khải - © 2023 Do Not Reup<br></footer>`
