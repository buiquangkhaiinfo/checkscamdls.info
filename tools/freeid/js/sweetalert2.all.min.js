...
!function(e, t) {
    ...
    const t = e=>{
      ...
      , q = (e,t,i)=>{
        ...
        t.customClass && t.customClass[i]) {
            if ("string" != typeof t.customClass[i] && !t.customClass[i].forEach)
                return void r(`Invalid type of customClass.${i}! Expected string or iterable object, got "${typeof t.customClass[i]}"`);
            R(e, t.customClass[i])
        }
    }
      , V = (e,t)=>{
      ...
      , _ = (e,t)=>{
        ...
        for (let e = 0; e < n.length; e++) {
            const o = n[e];
            if (o instanceof HTMLElement && D(o, t))
                return o
        }
    }
      , W = (e,t,n)=>{
      ...
      , te = e=>new Promise((t=>{
        ...
        ee.restoreFocusTimeout = setTimeout((()=>{
            ee.previousActiveElement instanceof HTMLElement ? (ee.previousActiveElement.focus(),
      ...
      , se = e=>{
        const t = (()=>{
            const e = g();
            return !!e && (e.remove(),
            U([document.documentElement, document.body], [n["no-backdrop"], n["toast-shown"], n["has-column"]]),
            !0)
        }
        )();
        if (ne())
    ...
    const pe = (e,t)=>{
        ...
        function(e, t) {
            t in n ? R(e, n[t]) : (r('The "position" parameter is not valid, defaulting to "center"'),
            R(e, n.center))
        }(o, t.position),
        function(e, t) {
    ...
    const me = ["input", "file", "range", "select", "radio", "checkbox", "textarea"]
      , ge = e=>{
        if (!Ce[e.input])
            return void a(`Unexpected type of input! Expected "text", "email", "password", "number", "tel", "select", "radio", "checkbox", "textarea", "file" or "url", got "${e.input}"`);
        const t = we(e.input)
          , n = Ce[e.input](t, e);
        z(t),
      ...
      , Ce = {};
    Ce.text = Ce.email = Ce.password = Ce.number = Ce.tel = Ce.url = (e,t)=>(ve(e, t.inputValue),
    ye(e, e, t),
    be(e, t),
    e.type = t.input,
    e),
    Ce.file = (e,t)=>(ye(e, e, t),
    be(e, t),
    e),
    Ce.range = (e,t)=>{
        const n = e.querySelector("input")
          , o = e.querySelector("output");
        return ve(n, t.inputValue),
        n.type = t.input,
        ve(o, t.inputValue),
        ye(n, e, t),
        e
    ...
    const Ae = (t,o)=>{
        ...
        q(i, o, "htmlContainer"),
        o.html ? (re(o.html, i),
        z(i, "block")) : o.text ? (i.textContent = o.text,
        z(i, "block")) : K(i),
        ((t,o)=>{
            const i = b()
      ...
      , $e = (e,t)=>{
        ...
        t.toast ? (R([document.documentElement, document.body], n["toast-shown"]),
        R(e, n.toast)) : R(e, n.modal),
        q(e, t, "popup"),
      ...
      , Te = e=>{
        ...
        return R(t, n["progress-step"]),
        I(t, e),
        t
    }
      , Se = e=>{
        const t = document.createElement("li");
        return R(t, n["progress-step-line"]),
      ...
      , Le = (t,i)=>{
        ((e,t)=>{
            const n = g()
              , o = b();
            t.toast ? (W(n, "width", t.width),
            o.style.width = "100%",
            o.insertBefore(E(), y())) : W(o, "width", t.width),
        ...
        ((e,t)=>{
            const o = A();
            t.progressSteps && 0 !== t.progressSteps.length ? (z(o),
            o.textContent = "",
        ...
        ((t,n)=>{
            ...
            if (n.icon || n.iconHtml) {
                if (n.icon && -1 === Object.keys(o).indexOf(n.icon))
                    return a(`Unknown icon! Expected "success", "error", "warning", "info" or "question", got "${n.icon}"`),
                    void K(s);
                z(s),
                Pe(s, n),
                ke(s, n),
    ...
    const Me = ()=>B() && B().click()
      ...
      , Ne = (t,n,o)=>{
        ...
        "Enter" === n.key ? Fe(t, n, i) : "Tab" === n.key ? Re(n) : [...qe, ...Ve].includes(n.key) ? Ue(n.key) : "Escape" === n.key && _e(n, i, o)))
    }
      , Fe = (e,t,n)=>{
      ...
      , Ue = e=>{
        ...
        for (let e = 0; e < $().children.length; e++) {
            ...
            !o)
                return;
            if (o instanceof HTMLButtonElement && J(o))
                break
        }
        o instanceof HTMLButtonElement && o.focus()
    }
      , _e = (e,t,n)=>{
        u(t.allowEscapeKey) && (e.preventDefault(),
        n(He.esc))
    }
    ;
    var We = {
    ...
    function et(e) {
        ...
        const t = We.swalPromiseResolve.get(this)
          , n = tt(this);
        this.isAwaitingPromise() ? e.isDismissed || (nt(this),
        t(e)) : n && t(e)
    }
    const tt = t=>{
        const n = b();
        ...
        if (!o || D(n, o.hideClass.popup))
            return !1;
        U(n, o.showClass.popup),
        R(n, o.hideClass.popup);
        const i = g();
        return U(i, o.showClass.backdrop),
    ...
    const nt = t=>{
      ...
      , it = (e,t,n)=>{
        ...
        i ? st(e, t, o, n.returnFocus, n.didClose) : Qe(e, o, n.returnFocus, n.didClose)
    }
      , st = (e,t,n,o,i)=>{
    ...
    const vt = e=>{
      ...
      , Ct = t=>{
        t.isAwaitingPromise() ? (At(e, t),
        e.awaitingPromise.set(t, !0)) : (At(We, t),
        At(e, t))
    }
      , At = (e,t)=>{
        for (const n in e)
    ...
    var kt = Object.freeze({
        ...
        showValidationMessage: function(t) {
            ...
            i.customClass && i.customClass.validationMessage && R(o.validationMessage, i.customClass.validationMessage),
        ...
        update: function(t) {
            ...
            if (!n || D(n, o.hideClass.popup))
                return void r("You're trying to update the closed or closing popup, that won't work. Use the update() method in preConfirm parameter or show a new popup.");
            const i = wt(t)
              , s = Object.assign({}, o, i);
            Le(this, s),
        ...
        _destroy: function() {
            ...
            n ? (t.popup && ee.swalCloseEventFinishedCallback && (ee.swalCloseEventFinishedCallback(),
            delete ee.swalCloseEventFinishedCallback),
    ...
    const Bt = e=>{
      ...
      , Tt = (e,t)=>{
        ...
        ;
        d(t.inputOptions) || m(t.inputOptions) ? (Bt(B()),
      ...
      , Mt = (t,n)=>{
        const o = e.innerParams.get(t);
        if (!o.input)
            return void a(`The "input" parameter is needed to be set when using returnInputValueOn${s(n)}`);
        const i = ((e,t)=>{
            const n = e.getInput();
            if (!n)
                return null;
        ...
        o.inputValidator ? Ht(t, i, n) : t.getInput().checkValidity() ? "deny" === n ? It(t, i) : Vt(t, i) : (t.enableButtons(),
      ...
      , Vt = (t,n)=>{
        const o = e.innerParams.get(t || void 0);
        if (o.showLoaderOnConfirm && Bt(),
        o.preConfirm) {
            t.resetValidationMessage(),
            e.awaitingPromise.set(t || void 0, !0);
            Promise.resolve().then((()=>p(o.preConfirm(n, o.validationMessage)))).then((e=>{
                J(k()) || !1 === e ? (t.hideLoading(),
                nt(t)) : Dt(t, void 0 === e ? n : e)
            }
            )).catch((e=>qt(t || void 0, e)))
        } else
            Dt(t, n)
    ...
    const en = ["swal-title", "swal-html", "swal-footer"]
      ...
      , sn = e=>{
        ...
        return n && (un(n, ["src", "width", "height", "alt"]),
      ...
      , an = e=>{
        ...
        n && (un(n, ["type", "label", "placeholder", "value"]),
      ...
      , dn = e=>{
        ...
        j() && (gn(t, e.scrollbarPadding, i),
        Array.from(document.body.children).forEach((e=>{
            e === g() || e.contains(g()) || (e.hasAttribute("aria-hidden") && e.setAttribute("data-previous-aria-hidden", e.getAttribute("aria-hidden")),
      ...
      , mn = (e,t)=>{
        ce && G(t) ? (e.style.overflowY = "hidden",
        t.addEventListener(ce, pn)) : e.style.overflowY = "auto"
    }
      , gn = (e,t,o)=>{
        (()=>{
    ...
    const vn = (t,n,o)=>new Promise(((i,s)=>{
        ...
        ,
        ((t,n,o)=>{
            e.innerParams.get(t).toast ? Nt(t, n, o) : (Ut(n),
            _t(n),
            Wt(t, n, o))
        }
        )(t, n, r),
        ((e,t,n,o)=>{
            Ie(t),
            n.toast || (t.keydownHandler = t=>Ne(e, t, o),
        ...
        ((e,t)=>{
            "select" === t.input || "radio" === t.input ? Tt(e, t) : ["text", "email", "number", "tel", "textarea"].includes(t.input) && (d(t.inputValue) || m(t.inputValue)) && (Bt(B()),
            St(e, t))
        }
        )(t, o),
        dn(o),
      ...
      , Cn = (e,t)=>{
        ...
        return o.showClass = Object.assign({}, ct.showClass, o.showClass),
      ...
      , Pn = (e,t)=>t.focusDeny && J(e.denyButton) ? (e.denyButton.focus(),
    !0) : t.focusCancel && J(e.cancelButton) ? (e.cancelButton.focus(),
    !0) : !(!t.focusConfirm || !J(e.confirmButton)) && (e.confirmButton.focus(),
    !0)
      , xn = ()=>{
