...
<html lang="vi">
  <head>
    ...
    <meta name="keywords" content="Tool spam sms, spam call free, Spam SMS Free, tool spam sms crowsspamsms, spam call sms, Web spam sms" />
...
if(isset($_POST["key"])){
	...
	if($key == "khaidev" or $key == "quangkhai" or $check["status"] == "success"){/*
		...
		if(isset($_POST["phone"])){
            ...
            echo "<style>.swal2-title{color: #fff !important;font-size: 2rem;}</style><script>Swal.fire('Kết quả', 'Spam Server API CrowS - Thành công: 0 - Thất bại: 0 -  Vui Lòng Nhập Đúng Số Phone', 'error')</script>";; exit;; exit;
		}
	} else {
		echo "<style>.swal2-title{color: #fff !important;font-size: 2rem;}</style><script>Swal.fire('Kết quả', 'Spam Server API CrowS - Thành công: 0 - Thất bại: 0 -  Key Sai', 'error')</script>";; exit;
	}
}
if(strlen($sdt) < 10){
	echo "<style>.swal2-title{color: #fff !important;font-size: 2rem;}</style><script>Swal.fire('Kết quả', 'Spam Server API CrowS - Thành công: 0 - Thất bại: 0 -  Vui Lòng Nhập Đúng Số Phone', 'error')</script>";; exit;; exit;
	...
	echo "<style>.swal2-title{color: #fff !important;font-size: 2rem;}</style><script>Swal.fire('Kết quả', 'Spam Server API CrowS - Thành công: 0 - Thất bại: 0 -  Số đã được cấp anti spam ở web này !', 'error')</script>";; exit;; exit;
}
echo "<style>.swal2-title{color: #fff !important;font-size: 2rem;}</style><script>Swal.fire('Kết quả', 'Spam Server API CrowS - Thành công: 0 - Thất bại: 0', 'success')</script>";;
